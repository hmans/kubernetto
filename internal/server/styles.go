...
.status-pill.good { background: #ddf7ec; color: var(--good); }
.status-pill.warn { background: #fff4dd; color: var(--warn); }
.status-pill.neutral { background: #e9f1f5; color: var(--accent-2); }
.detail-list {
  margin: 0;
