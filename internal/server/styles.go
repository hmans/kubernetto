...
.overview-stats .overview-link:last-child {
  border-right: 0;
}
...
.resource-counts .overview-link:last-child {
  border-right: 0;
}
...
@media (max-width: 860px) {
  ...
  .overview-stats .overview-link:nth-child(2n) { border-right: 0; }
  .overview-identity { grid-template-columns: 1fr; }
  .resource-counts { grid-template-columns: 1fr; }
  .resource-counts .overview-link {
    border-right: 0;
  }
  .content-grid,
  .content-grid.has-detail { grid-template-columns: 1fr; }
  .detail-panel {
    max-height: none;
    position: static;
  }
